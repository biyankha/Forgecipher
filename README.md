...
An airdrop is an applicawhere a set number are able to claim a amn today's ecosystem, this is often used to distribute tokens to an application's user base that has previously interacted with their project.
